...
NAME           := your-starter
PACKAGE_NAME   := github.com/yourname/your-starter
ENTRY_PKG      := ./cli/your-starter
...
# cmdr-go-starter: build executable for current GOOS & GOARCH
cmdr-go-starter: cmdr
...
# what `make cmdr-go-starter` does.
